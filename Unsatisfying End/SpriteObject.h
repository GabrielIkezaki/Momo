...
public:
	...
	virtual void Set(std::string tempTexture, sf::Vector2f position, sf::Vector2f origin, sf::Vector2f scale);	//Passes down the texture, position and scale of the objectSprite
