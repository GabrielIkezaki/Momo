...
public:
	...
	Animation(sf::Texture* texture, sf::Vector2u imageCount, float switchTime, bool loop);		//Sets the spritesheet that will be animated, the cell count and time between each animation frame
